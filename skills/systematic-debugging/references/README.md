...
- Read main [SKILL.md](../SKILL.md) — follow the systematic process

### For Technology-Specific Issues

- [debugging-strategies.md](debugging-strategies.md) — React, Node.js, TypeScript, API debugging
...
### [debugging-strategies.md](debugging-strategies.md)
...
- [debugging-strategies.md](debugging-strategies.md) → Technology-specific techniques; pairs with SKILL.md's systematic process
- [common-mistakes.md](common-mistakes.md) → Error pattern catalog; use after isolating the component in SKILL.md's process
- Related skills: [unit-testing](../../unit-testing/SKILL.md), [typescript](../../typescript/SKILL.md)
